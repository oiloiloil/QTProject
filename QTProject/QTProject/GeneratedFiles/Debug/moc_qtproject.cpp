...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTProject_t, stringdata) + ofs \
...
const QMetaObject QTProject::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QTProject.data,
      qt_meta_data_QTProject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTProject.stringdata))
        return static_cast<void*>(const_cast< QTProject*>(this));
